...
class SubNetwork(nn.Module):
    def __init__(self, input_chns, output_chns, chns):
        ...
        self.conv1 = nn.Conv2d(in_channels=input_chns, out_channels=chns, kernel_size=9, stride=1, padding=4, bias=True)
        self.conv2 = nn.Conv2d(in_channels=chns, out_channels=chns, kernel_size=3, stride=1, padding=1, bias=True)
        self.conv3 = nn.Conv2d(in_channels=chns, out_channels=output_chns, kernel_size=5, stride=1, padding=2, bias=True)
